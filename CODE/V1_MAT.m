function [CMQmat,CMQ]=V1_MAT(bcell,smcell,interval,cellnum,cellnumjy,smcellnum,widght,tp1,tp2,t,h,OSS)
%--------------------------------------------------------------------------
%Computing ODE
% 
%input argument
...
for i=1:tp2-1
    ...
    image_t=V1_mapping(cdnt,t,h,OSS);
    ...
    eval(['midt',num2str(i),'=histc(midt_',num2str(i),',[1:lg(',num2str(i),')]'')/smcellnum;']);
end
